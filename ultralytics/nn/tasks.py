...
C3K2_CLASS = (C3k2_Faster, C3k2_ODConv, C3k2_Faster_EMA, C3k2_DBB, C3k2_DeepDBB, C3k2_WDBB, C3k2_CloAtt, C3k2_SCConv, C3k2_ScConv, C3k2_EMSC, C3k2_EMSCP, C3k2_KW, C3k2_DySnakeConv, C3k2_DCNv2, C3k2_DCNv3,
              ...
              C3k2_CAMixer, C3k2_HFERB, C3k2_DTAB, C3k2_JDPM, C3k2_ETB, C3k2_FDT, C3k2_AP, C3k2_ELGCA, C3k2_ELGCACGLU, C3k2_Strip, C3k2_StripCGLU, C3k2_Kat, C3k2_Faster_KAN, DAFE-S, DAFE-S_KAN, C3k2_GlobalFilter, C3k2_DynamicFilter,
              C3k2_TSSA, C3k2_SAVSS, C3k2_MobileMamba, C3k2_MambaOut, C3k2_MambaOut_UniRepLK, C3k2_EfficientVIM, C3k2_EfficientVIM_CGLU
              )
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in ((
            ...
            MANet_Star, PSConv, C2Pola, A2C2f, C2TSSA,RepHMS,C2ASSA, C2PSA_DYT, C2TSSA_DYT, C2Pola_DYT,MF,
             CSP_MSCB_SC
        ) + C3K2_CLASS):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            ...
            if m in ((
                ...
                MANet_FasterBlock, MANet_FasterCGLU, MANet_Star, C2Pola, A2C2f, C2TSSA,C2ASSA, C2PSA_DYT,
                C2TSSA_DYT, C2Pola_DYT, CSP_MSCB_SC
            ) + C3K2_CLASS):
            ...
            if m in SEGMENT_CLASS:
                ...
                if m in (Segment_LSCD, Segment_TADDH, Segment_LSCSBD, Segment_LSDECD, Segment_RSCD, Segment_LSCD_LQE):
                    args[3] = make_divisible(min(args[3], max_channels) * width, 8)
            if m in (Detect_LSCD, Detect_TADDH, Detect_LSCSBD, Detect_LSDECD, Detect_RSCD, ShareQual):
