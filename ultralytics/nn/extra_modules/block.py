...
__all__ = ['DyHeadBlock', 'DyHeadBlockWithDCNV3', 'Fusion', 'C3k2_Faster', 'C3k2_ODConv', 'Partial_conv3', 'C3k2_Faster_EMA', 'C3k2_DBB',
           ...
           'WFU', 'FDT', 'C3k2_AP', 'PSConv', 'ContrastDrivenFeatureAggregation', 'C3k2_ELGCA', 'C3k2_ELGCACGLU', 'C3k2_Strip', 'C3k2_StripCGLU', 'MultiScalePCA', 'MultiScalePCA_Down', 'FSA', 'C3k2_Kat', 'C3k2_Faster_KAN', 'DAFE-S', '_KAN', 'C3k2_GlobalFilter',
...
class C3k2_SAVSS(C3k2):
    def __init__(self, c1, c2, n=1, size=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(C3k_SAVSS(self.c, self.c, n, size, shortcut, g) if c3k else SAVSS_Layer(self.c) for _ in range(n))
...
class C3k2_MobileMamba(C3k2):
    def __init__(self, c1, c2, n=1, size=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(C3k_MobileMamba(self.c, self.c, n, size, shortcut, g) if c3k else MobileMambaBlock(self.c) for _ in range(n))
...
class C3k2_MambaOut(C3k2):
    def __init__(self, c1, c2, n=1, size=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(C3k_MambaOut(self.c, self.c, n, size, shortcut, g) if c3k else GatedCNNBlock_BCHW(self.c) for _ in range(n))
...
class C3k2_MambaOut_UniRepLK(C3k2):
    def __init__(self, c1, c2, n=1, size=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(C3k_MambaOut_UniRepLK(self.c, self.c, n, size, shortcut, g) if c3k else GatedUniRepLKBlock_BCHW(self.c) for _ in range(n))
...
class C3k2_EfficientVIM(C3k2):
    def __init__(self, c1, c2, n=1, size=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(C3k_EfficientVIM(self.c, self.c, n, size, shortcut, g) if c3k else EfficientViMBlock(self.c) for _ in range(n))
...
class C3k2_EfficientVIM_CGLU(C3k2):
    def __init__(self, c1, c2, n=1, size=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(C3k_EfficientVIM_CGLU(self.c, self.c, n, size, shortcut, g) if c3k else EfficientViMBlock_CGLU(self.c) for _ in range(n))
