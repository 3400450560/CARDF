...
from ultralytics.utils import DEFAULT_CFG, LOGGER, SETTINGS, TESTS_RUNNING, colorstr
...
def _log_tensorboard_graph(trainer):
    ...
    im = torch.zeros((1, DEFAULT_CFG.ch, *imgsz), device=p.device, dtype=p.dtype)  # input image (must be zeros, not empty)
